let mode_method = function(team1,team2,mn,index_one,index_two,series_index,mode,sport_id,fantasy)
{
    ...
    if(mode==0)
    {
        handle_smart_section(index_one,index_two,team1,team2,mn,98,100,[],[],index_one,index_two,index_one,index_two,selected_tsd,series_index,mode,sport_id,fantasy)
    }
    else if(mode==1)
    {
